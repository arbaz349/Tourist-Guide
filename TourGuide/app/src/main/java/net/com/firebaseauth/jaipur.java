...
public class jaipur extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, jaipurloc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, jaipinfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, jaipurmon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, jaipurhang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent inte = new Intent(this, jaipshop.class);
                startActivity(inte);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, jaiprest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Jaipur");
            lc.setLatitude(26.9124);
            lc.setLongitude(75.7873);
