...
public class bangalore extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, bangaloreloc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, banginfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, bangmon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, banghang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent inte = new Intent(this, bangshop.class);
                startActivity(inte);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, bangrest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Bangalore");
            lc.setLatitude(12.9716);
            lc.setLongitude(77.5946);
