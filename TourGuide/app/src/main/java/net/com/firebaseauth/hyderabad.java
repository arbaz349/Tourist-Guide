...
public class hyderabad extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, hyderabadloc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, hyderinfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, hydermon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, hyderhang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent inte = new Intent(this, hydershop.class);
                startActivity(inte);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, hyperest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Hyderabad");
            lc.setLatitude(17.3850);
            lc.setLongitude(78.4867);
