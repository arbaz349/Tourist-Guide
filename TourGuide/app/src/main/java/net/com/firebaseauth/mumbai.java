...
public class mumbai extends AppCompatActivity implements View.OnClickListener, ConnectionCallbacks,
        ...
        LocationListener
{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, mumbailoc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, mumbainfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent=new Intent(this,mumbaimon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm =new Intent(this,mumbaihang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent inte=new Intent(this,mumbaishop.class);
                startActivity(inte);
                // do your code
                break;

            case R.id.rest:
                Intent inten=new Intent(this,mumbairest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Mumbai");
            lc.setLatitude(19.0760);
            lc.setLongitude(72.8777);
