...
public class pune extends AppCompatActivity implements View.OnClickListener, ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, puneloc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, puneinfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, punemon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, punehang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent intl = new Intent(this, puneshop.class);
                startActivity(intl);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, punerest.class);
                startActivity(inten);
                // do your code
                break;
