...
public class chennai extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.name:
                // do your code
                Intent i = new Intent(this, chennailoc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, chennainfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, chennaimon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, chennaihang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent intl = new Intent(this, chennaishop.class);
                startActivity(intl);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, chennairest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Chennai");
            lc.setLatitude(13.0827);
            lc.setLongitude(80.2707);
