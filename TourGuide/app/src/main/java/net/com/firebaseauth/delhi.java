...
public class delhi extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, delhiloc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, delhinfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, delhimon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, delhihang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent inte = new Intent(this, delhishop.class);
                startActivity(inte);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, delhirest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Delhi");
            lc.setLatitude(28.7041);
            lc.setLongitude(77.1025);
