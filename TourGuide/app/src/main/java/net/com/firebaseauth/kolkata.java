...
public class kolkata extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.name:
                // do your code
                Intent i = new Intent(this, kolkataloc.class);
                startActivity(i);
                break;

            case R.id.infp:
                Intent in = new Intent(this, kolkatainfo.class);
                startActivity(in);
                // do your code
                break;

            case R.id.mon:
                Intent intent = new Intent(this, kolkatamon.class);
                startActivity(intent);
                // do your code
                break;

            case R.id.hang:
                Intent intm = new Intent(this, kolkatahang.class);
                startActivity(intm);
                // do your code
                break;

            case R.id.shop:
                Intent inte = new Intent(this, kolkatashop.class);
                startActivity(inte);
                // do your code
                break;

            case R.id.rest:
                Intent inten = new Intent(this, kolkatarest.class);
                startActivity(inten);
                // do your code
                break;
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            float result ;
            Location lc = new Location("Kolkata");
            lc.setLatitude(22.5726);
            lc.setLongitude(88.3639);
